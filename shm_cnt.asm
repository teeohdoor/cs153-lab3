...
struct shm_cnt *counter;
  pid=fork();
    1018:	e8 2e 03 00 00       	call   134b <fork>
  sleep(1);
  ...
  sleep(1);
    1024:	e8 ba 03 00 00       	call   13e3 <sleep>
...
//print something because we are curious and to give a chance to switch process
    ...
    1083:	50                   	push   %eax
    1084:	ff 70 04             	pushl  0x4(%eax)
    1087:	56                   	push   %esi
    1088:	68 a8 18 00 00       	push   $0x18a8
    108d:	6a 01                	push   $0x1
    108f:	e8 2c 04 00 00       	call   14c0 <printf>
  ...
  if(pid)
    ...
    10ac:	51                   	push   %ecx
    10ad:	50                   	push   %eax
    10ae:	68 75 18 00 00       	push   $0x1875
    10b3:	6a 01                	push   $0x1
    10b5:	e8 06 04 00 00       	call   14c0 <printf>
    wait();
    10ba:	e8 9c 02 00 00       	call   135b <wait>
...
//shm_close: first process will just detach, next one will free up the shm_table entry (but for now not the page)
   shm_close(1);
    ...
    10c5:	6a 01                	push   $0x1
    10c7:	e8 2f 03 00 00       	call   13fb <shm_close>
   exit();
    10cc:	e8 82 02 00 00       	call   1353 <exit>
    printf(1,"Counter in child is %d\n\n",counter->cnt);
    10d1:	52                   	push   %edx
    10d2:	50                   	push   %eax
    10d3:	68 8e 18 00 00       	push   $0x188e
    10d8:	6a 01                	push   $0x1
    10da:	e8 e1 03 00 00       	call   14c0 <printf>
    ...
    141c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1449:	0f b6 92 d4 18 00 00 	movzbl 0x18d4(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1644:	eb 1a                	jmp    1660 <printf+0x1a0>
          s = "(null)";
    1646:	bb cb 18 00 00       	mov    $0x18cb,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1695:	a1 c8 1b 00 00       	mov    0x1bc8,%eax
{
    ...
    16b6:	73 10                	jae    16c8 <free+0x38>
{
  ...
  freep = p;
    ...
    16e1:	5b                   	pop    %ebx
  freep = p;
    16e2:	a3 c8 1b 00 00       	mov    %eax,0x1bc8
}
    16e7:	5e                   	pop    %esi
    16e8:	5f                   	pop    %edi
    16e9:	5d                   	pop    %ebp
  ...
  freep = p;
    170a:	a3 c8 1b 00 00       	mov    %eax,0x1bc8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1730:	8b 3d c8 1b 00 00    	mov    0x1bc8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1779:	8b 3d c8 1b 00 00    	mov    0x1bc8,%edi
  ...
  return freep;
    17a7:	a1 c8 1b 00 00       	mov    0x1bc8,%eax
    ...
    17d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    17d7:	a3 c8 1b 00 00       	mov    %eax,0x1bc8
}
    ...
    base.s.ptr = freep = prevp = &base;
    17f0:	c7 05 c8 1b 00 00 cc 	movl   $0x1bcc,0x1bc8
    17f7:	1b 00 00 
    base.s.size = 0;
    17fa:	bf cc 1b 00 00       	mov    $0x1bcc,%edi
    base.s.ptr = freep = prevp = &base;
    17ff:	c7 05 cc 1b 00 00 cc 	movl   $0x1bcc,0x1bcc
    1806:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    180b:	c7 05 d0 1b 00 00 00 	movl   $0x0,0x1bd0
    1812:	00 00 00 
    if(p->s.size >= nunits){
