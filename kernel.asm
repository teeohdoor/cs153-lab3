...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 f2 7d 10 80 	movl   $0x80107df2,(%esp)
...
80101254:	68 9f 74 10 80       	push   $0x8010749f
...
801013a2:	68 b5 74 10 80       	push   $0x801074b5
...
8010146b:	68 c5 74 10 80       	push   $0x801074c5
...
80101534:	68 d8 74 10 80       	push   $0x801074d8
...
80102020:	68 26 7b 10 80       	push   $0x80107b26
...
80102486:	81 fb f4 57 11 80    	cmp    $0x801157f4,%ebx
...
8010305b:	68 f4 57 11 80       	push   $0x801157f4
...
801031ae:	68 d8 78 10 80       	push   $0x801078d8
...
8010326a:	68 dd 78 10 80       	push   $0x801078dd
...
801033c3:	68 e2 78 10 80       	push   $0x801078e2
801033c8:	e8 c3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033cd:	83 ec 0c             	sub    $0xc,%esp
801033d0:	68 fc 78 10 80       	push   $0x801078fc
...
80103474:	00 00 00 
  initlock(&p->lock, "pipe");
80103477:	68 1b 79 10 80       	push   $0x8010791b
...
8010393d:	68 04 7a 10 80       	push   $0x80107a04
...
80103a43:	68 50 79 10 80       	push   $0x80107950
80103a48:	50                   	push   %eax
80103a49:	e8 c2 0d 00 00       	call   80104810 <safestrcpy>
  p->cwd = namei("/");
80103a4e:	c7 04 24 59 79 10 80 	movl   $0x80107959,(%esp)
...
80103a87:	68 37 79 10 80       	push   $0x80107937
...
80103ebd:	68 a8 79 10 80       	push   $0x801079a8
80103ec2:	e8 c9 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103ec7:	83 ec 0c             	sub    $0xc,%esp
80103eca:	68 9b 79 10 80       	push   $0x8010799b
...
80103fd9:	68 ba 79 10 80       	push   $0x801079ba
80103fde:	e8 ad c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fe3:	83 ec 0c             	sub    $0xc,%esp
80103fe6:	68 b4 79 10 80       	push   $0x801079b4
...
80104203:	68 f2 7d 10 80       	push   $0x80107df2
...
80104224:	74 ea                	je     80104210 <procdump+0x30>
      state = "???";
80104226:	ba cb 79 10 80       	mov    $0x801079cb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010422b:	83 f8 05             	cmp    $0x5,%eax
8010422e:	77 11                	ja     80104241 <procdump+0x61>
80104230:	8b 14 85 2c 7a 10 80 	mov    -0x7fef85d4(,%eax,4),%edx
      state = "???";
80104237:	b8 cb 79 10 80       	mov    $0x801079cb,%eax
...
80104246:	68 cf 79 10 80       	push   $0x801079cf
...
80104285:	68 21 74 10 80       	push   $0x80107421
...
801042be:	68 44 7a 10 80       	push   $0x80107a44
...
8010458b:	68 4f 7a 10 80       	push   $0x80107a4f
...
801045e5:	68 57 7a 10 80       	push   $0x80107a57
801045ea:	e8 a1 bd ff ff       	call   80100390 <panic>
    panic("popcli");
801045ef:	83 ec 0c             	sub    $0xc,%esp
801045f2:	68 6e 7a 10 80       	push   $0x80107a6e
...
80104615:	68 75 7a 10 80       	push   $0x80107a75
...
80104a40:	8b 14 85 a0 7a 10 80 	mov    -0x7fef8560(,%eax,4),%edx
...
80104a68:	68 7d 7a 10 80       	push   $0x80107a7d
...
80104bc4:	68 1c 7b 10 80       	push   $0x80107b1c
...
80104bdc:	68 1b 7b 10 80       	push   $0x80107b1b
...
80104bf1:	68 0f 7b 10 80       	push   $0x80107b0f
...
80104c0f:	68 1e 7b 10 80       	push   $0x80107b1e
80104c14:	e8 77 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c19:	83 ec 0c             	sub    $0xc,%esp
80104c1c:	68 00 7b 10 80       	push   $0x80107b00
...
8010500d:	58                   	pop    %eax
8010500e:	5a                   	pop    %edx
8010500f:	68 1c 7b 10 80       	push   $0x80107b1c
...
80105028:	68 1b 7b 10 80       	push   $0x80107b1b
...
80105702:	e8 39 1c 00 00       	call   80107340 <shm_close>
...
80105937:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
8010593e:	08 00 00 8e 
80105942:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105949:	80 
8010594a:	c1 ea 10             	shr    $0x10,%edx
8010594d:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105954:	80 
  for(i = 0; i < 256; i++)
...
80105967:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 61 7b 10 80       	push   $0x80107b61
80105976:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010597b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105981:	c1 e8 10             	shr    $0x10,%eax
80105984:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
...
801059af:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059b3:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
801059f4:	3e ff 24 85 08 7c 10 	notrack jmp *-0x7fef83f8(,%eax,4)
801059fb:	80 
    lapiceoi();
    break;
...
80105a51:	68 c4 7b 10 80       	push   $0x80107bc4
...
80105af7:	68 60 4c 11 80       	push   $0x80114c60
80105afc:	e8 cf e9 ff ff       	call   801044d0 <acquire>
      wakeup(&ticks);
80105b01:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105b08:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105b0f:	e8 dc e5 ff ff       	call   801040f0 <wakeup>
      release(&tickslock);
80105b14:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
...
80105b6c:	68 6c 7b 10 80       	push   $0x80107b6c
...
80105c08:	68 90 7b 10 80       	push   $0x80107b90
80105c0d:	e8 9e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c12:	83 c4 14             	add    $0x14,%esp
80105c15:	68 66 7b 10 80       	push   $0x80107b66
...
80105d13:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d18:	bb 88 7c 10 80       	mov    $0x80107c88,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80106943:	68 46 76 10 80       	push   $0x80107646
...
8010696e:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
80106975:	ff 00 00 
80106978:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
8010697f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106982:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106989:	ff 00 00 
8010698c:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
80106993:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106996:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
8010699d:	ff 00 00 
801069a0:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
801069a7:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801069aa:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
801069b1:	ff 00 00 
801069b4:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
801069bb:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801069be:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
...
80106a65:	68 90 7c 10 80       	push   $0x80107c90
...
80106a74:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106c11:	68 d5 7c 10 80       	push   $0x80107cd5
...
80106d86:	68 0d 7d 10 80       	push   $0x80107d0d
...
80106ddb:	68 25 7d 10 80       	push   $0x80107d25
...
80106ecc:	68 41 7d 10 80       	push   $0x80107d41
...
80106fa3:	68 52 7d 10 80       	push   $0x80107d52
...
80107076:	68 5c 7d 10 80       	push   $0x80107d5c
8010707b:	e8 10 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80107080:	83 ec 0c             	sub    $0xc,%esp
80107083:	68 76 7d 10 80       	push   $0x80107d76
...
8010716a:	68 b3 7d 10 80       	push   $0x80107db3
8010716f:	68 c0 54 11 80       	push   $0x801154c0
80107174:	e8 47 d2 ff ff       	call   801043c0 <initlock>
  acquire(&(shm_table.lock));
80107179:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80107180:	e8 4b d3 ff ff       	call   801044d0 <acquire>
  for (i = 0; i< 64; i++) {
80107185:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
...
801071a0:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for (i = 0; i< 64; i++) {
801071a7:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
801071ac:	75 e2                	jne    80107190 <shminit+0x30>
  }
  release(&(shm_table.lock));
801071ae:	83 ec 0c             	sub    $0xc,%esp
801071b1:	68 c0 54 11 80       	push   $0x801154c0
...
801071cc:	83 ec 1c             	sub    $0x1c,%esp
801071cf:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801071d2:	e8 99 c7 ff ff       	call   80103970 <myproc>
...
801071dc:	8b 00                	mov    (%eax),%eax
  acquire(&(shm_table.lock));
801071de:	68 c0 54 11 80       	push   $0x801154c0
  char *va = (char *)PGROUNDUP(curproc->sz);
801071e3:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801071e6:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
  acquire(&(shm_table.lock));
801071ec:	e8 df d2 ff ff       	call   801044d0 <acquire>
  struct shm_page *pg = 0;
801071f1:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801071f4:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
...
80107208:	39 18                	cmp    %ebx,(%eax)
8010720a:	0f 44 f8             	cmove  %eax,%edi
  for (i = 0; i < 64; i++) {
8010720d:	83 c0 0c             	add    $0xc,%eax
80107210:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80107215:	75 f1                	jne    80107208 <shm_open+0x48>
      pg = shm_table.shm_pages + i;
    }
  }

  if (pg){ // Case 1: ID already exists
80107217:	85 ff                	test   %edi,%edi
80107219:	74 58                	je     80107273 <shm_open+0xb3>
    if (!mappages(curproc->pgdir, va, PGSIZE, V2P(pg->frame),PTE_W|PTE_U)) {
8010721b:	83 ec 0c             	sub    $0xc,%esp
8010721e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80107221:	6a 06                	push   $0x6
80107223:	8b 47 04             	mov    0x4(%edi),%eax
80107226:	05 00 00 00 80       	add    $0x80000000,%eax
8010722b:	50                   	push   %eax
8010722c:	68 00 10 00 00       	push   $0x1000
80107231:	56                   	push   %esi
80107232:	ff 72 04             	pushl  0x4(%edx)
80107235:	e8 a6 f7 ff ff       	call   801069e0 <mappages>
8010723a:	83 c4 20             	add    $0x20,%esp
8010723d:	85 c0                	test   %eax,%eax
8010723f:	0f 85 c4 00 00 00    	jne    80107309 <shm_open+0x149>
      curproc->sz = (int)va + PGSIZE;
80107245:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107248:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
8010724e:	89 02                	mov    %eax,(%edx)
      pg->refcnt++;
      *pointer = va;
80107250:	8b 45 0c             	mov    0xc(%ebp),%eax
      pg->refcnt++;
80107253:	83 47 08 01          	addl   $0x1,0x8(%edi)
      *pointer = va;
80107257:	89 30                	mov    %esi,(%eax)
      release(&(shm_table.lock));
      return 1;
    }
  }
...
8010725c:	68 c0 54 11 80       	push   $0x801154c0
80107261:	e8 9a d3 ff ff       	call   80104600 <release>
...
80107271:	5d                   	pop    %ebp
80107272:	c3                   	ret    
80107273:	b9 f8 54 11 80       	mov    $0x801154f8,%ecx
    for (i = 0; i <64; i++) {
80107278:	31 c0                	xor    %eax,%eax
8010727a:	eb 13                	jmp    8010728f <shm_open+0xcf>
8010727c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107280:	83 c0 01             	add    $0x1,%eax
80107283:	83 c1 0c             	add    $0xc,%ecx
80107286:	83 f8 40             	cmp    $0x40,%eax
80107289:	0f 84 a4 00 00 00    	je     80107333 <shm_open+0x173>
      if (!shm_table.shm_pages[i].frame) {
8010728f:	8b 39                	mov    (%ecx),%edi
80107291:	85 ff                	test   %edi,%edi
80107293:	75 eb                	jne    80107280 <shm_open+0xc0>
        pg = shm_table.shm_pages + i;
80107295:	8d 0c 40             	lea    (%eax,%eax,2),%ecx
80107298:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010729b:	c1 e1 02             	shl    $0x2,%ecx
8010729e:	8d b9 f4 54 11 80    	lea    -0x7feeab0c(%ecx),%edi
801072a4:	89 4d e0             	mov    %ecx,-0x20(%ebp)
    pg->frame = kalloc();
801072a7:	e8 84 b3 ff ff       	call   80102630 <kalloc>
    memset(pg->frame, 0, PGSIZE);
801072ac:	83 ec 04             	sub    $0x4,%esp
    pg->frame = kalloc();
801072af:	89 47 04             	mov    %eax,0x4(%edi)
    memset(pg->frame, 0, PGSIZE);
801072b2:	68 00 10 00 00       	push   $0x1000
801072b7:	6a 00                	push   $0x0
801072b9:	50                   	push   %eax
801072ba:	e8 91 d3 ff ff       	call   80104650 <memset>
    if (!mappages(curproc->pgdir, va, PGSIZE, V2P(pg->frame), PTE_W|PTE_U)) {
801072bf:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
801072c6:	8b 47 04             	mov    0x4(%edi),%eax
801072c9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801072cc:	05 00 00 00 80       	add    $0x80000000,%eax
801072d1:	50                   	push   %eax
801072d2:	68 00 10 00 00       	push   $0x1000
801072d7:	56                   	push   %esi
801072d8:	ff 72 04             	pushl  0x4(%edx)
801072db:	e8 00 f7 ff ff       	call   801069e0 <mappages>
801072e0:	83 c4 20             	add    $0x20,%esp
801072e3:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801072e6:	8b 4d e0             	mov    -0x20(%ebp),%ecx
801072e9:	85 c0                	test   %eax,%eax
801072eb:	75 1c                	jne    80107309 <shm_open+0x149>
      curproc->sz = (int)va + PGSIZE;
801072ed:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
801072f3:	89 02                	mov    %eax,(%edx)
      *pointer = va;
801072f5:	8b 45 0c             	mov    0xc(%ebp),%eax
801072f8:	89 30                	mov    %esi,(%eax)
      pg->id = id;
801072fa:	89 99 f4 54 11 80    	mov    %ebx,-0x7feeab0c(%ecx)
      pg->refcnt++;
80107300:	83 47 08 01          	addl   $0x1,0x8(%edi)
80107304:	e9 50 ff ff ff       	jmp    80107259 <shm_open+0x99>
      cprintf("Shared page with id %d could not be mapped.\n", id);
80107309:	83 ec 08             	sub    $0x8,%esp
8010730c:	53                   	push   %ebx
8010730d:	68 f4 7d 10 80       	push   $0x80107df4
      cprintf("Shared memory table full.\n");
80107312:	e8 99 93 ff ff       	call   801006b0 <cprintf>
      release(&(shm_table.lock));
80107317:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
8010731e:	e8 dd d2 ff ff       	call   80104600 <release>
      return 1;
80107323:	83 c4 10             	add    $0x10,%esp
}
80107326:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return 1;
80107329:	b8 01 00 00 00       	mov    $0x1,%eax
}
8010732e:	5b                   	pop    %ebx
8010732f:	5e                   	pop    %esi
80107330:	5f                   	pop    %edi
...
80107336:	68 bc 7d 10 80       	push   $0x80107dbc
8010733b:	eb d5                	jmp    80107312 <shm_open+0x152>
...
8010734b:	8b 5d 08             	mov    0x8(%ebp),%ebx
//you write this too!
int i;
struct shm_page *pg = 0;
acquire(&(shm_table.lock));
8010734e:	68 c0 54 11 80       	push   $0x801154c0
80107353:	e8 78 d1 ff ff       	call   801044d0 <acquire>

for (i = 0; i < 64; i++) {
80107358:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
8010735d:	83 c4 10             	add    $0x10,%esp
struct shm_page *pg = 0;
80107360:	31 d2                	xor    %edx,%edx
80107362:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if (shm_table.shm_pages[i].id == id) {
80107368:	39 18                	cmp    %ebx,(%eax)
8010736a:	0f 44 d0             	cmove  %eax,%edx
for (i = 0; i < 64; i++) {
8010736d:	83 c0 0c             	add    $0xc,%eax
80107370:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80107375:	75 f1                	jne    80107368 <shm_close+0x28>
      pg = shm_table.shm_pages + i;
    }
  }
  	
if(pg == 0 || pg->refcnt == 0) {
80107377:	85 d2                	test   %edx,%edx
80107379:	74 35                	je     801073b0 <shm_close+0x70>
8010737b:	8b 42 08             	mov    0x8(%edx),%eax
8010737e:	85 c0                	test   %eax,%eax
80107380:	74 2e                	je     801073b0 <shm_close+0x70>
  cprintf("No shared memory to close.\n\n");
  release(&(shm_table.lock));
  return 1;
} else {
  pg->refcnt--;
80107382:	83 e8 01             	sub    $0x1,%eax
80107385:	89 42 08             	mov    %eax,0x8(%edx)
}

if(pg->refcnt == 0) {
80107388:	74 17                	je     801073a1 <shm_close+0x61>
  pg->id = 0;
  pg->frame = 0; 
}
...
8010738d:	68 c0 54 11 80       	push   $0x801154c0
80107392:	e8 69 d2 ff ff       	call   80104600 <release>

return 0; //added to remove compiler warning -- you should decide what to return
}
80107397:	8b 5d fc             	mov    -0x4(%ebp),%ebx
return 0; //added to remove compiler warning -- you should decide what to return
8010739a:	83 c4 10             	add    $0x10,%esp
8010739d:	31 c0                	xor    %eax,%eax
}
8010739f:	c9                   	leave  
801073a0:	c3                   	ret    
  pg->id = 0;
801073a1:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  pg->frame = 0; 
801073a7:	c7 42 04 00 00 00 00 	movl   $0x0,0x4(%edx)
801073ae:	eb da                	jmp    8010738a <shm_close+0x4a>
  cprintf("No shared memory to close.\n\n");
801073b0:	83 ec 0c             	sub    $0xc,%esp
801073b3:	68 d7 7d 10 80       	push   $0x80107dd7
801073b8:	e8 f3 92 ff ff       	call   801006b0 <cprintf>
  release(&(shm_table.lock));
801073bd:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
801073c4:	e8 37 d2 ff ff       	call   80104600 <release>
}
801073c9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  return 1;
801073cc:	83 c4 10             	add    $0x10,%esp
801073cf:	b8 01 00 00 00       	mov    $0x1,%eax
}
801073d4:	c9                   	leave  
801073d5:	c3                   	ret    
